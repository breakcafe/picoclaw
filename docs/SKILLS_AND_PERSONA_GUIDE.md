...
No prescriptive subdirectory structure is enforced. The `conversations/` directory is created on-demand by the PreCompact hook when context compaction occurs.
